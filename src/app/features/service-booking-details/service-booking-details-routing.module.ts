...
const routes: Routes = [
    {
        ...
        data: {
            title: 'Service Booking Detail list',
    ...
    },
    {
        ...
        data: {
            title: 'Create new Service Booking Detail',
            roles: RoleManager.allExcept(Role.Guest)
        },
    },
    {
        ...
        canDeactivate: [FormStateGuard],
        data: {
            title: 'Edit Service Booking Detail',
            roles: RoleManager.allExcept(Role.Guest)
        }
    },
    {
    ...
    },
    {
        ...
        redirectTo: '/service-booking-details/list', pathMatch: 'full'
    }
];
...
export class ServiceBookingDetailsRoutingModule {
}
