...
const routes: Routes = [
    ...
    },
    {
        ...
        data: {
            title: 'Create new Client Supervision Session',
            roles: RoleManager.allExcept(Role.Guest)
        },
    },
    {
        ...
        canDeactivate: [FormStateGuard],
        data: {
            title: 'Edit Client Supervision Session',
            roles: RoleManager.allExcept(Role.Guest)
        }
    },
    {
        ...
        canActivate: [AuthGuard],
        data: {
            title: 'Client Supervision Session',
            roles: RoleManager.allExcept(Role.Guest)
        }
    }
];
...
export class ClientSupervisionSessionRoutingModule {
}
