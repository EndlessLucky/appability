...
describe('features/client-stage/components/FormComponent', () => {
  ...
  it('form field are required', () => {
    component.form.controls.rank.setValue('');
  ...
  it('save button should be disabled when fileds are invalid', () => {
    component.form.controls.rank.setValue('no number');
    component.form.controls.active.setValue('no boolean');
    component.form.controls.isprojectstage.setValue('no boolean');
  ...
  it('save button should be enabled when fields are valid', () => {
    component.form.controls.rank.setValue('11.2');
    component.form.controls.active.setValue('true');
    component.form.controls.isprojectstage.setValue('true');
